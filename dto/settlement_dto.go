...
type CreateSettlementRequest struct {
	...
	ActualCash *float64 `json:"actual_cash" binding:"required,gte=0,lte=9999999999999.99"` // pointer permits zero but rejects missing values
}
...
type GetSettlementResponse struct {
	DebugResetEnabled bool                `json:"debug_reset_enabled"`
